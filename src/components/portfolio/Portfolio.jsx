...
const Portfolio = () => {
  const data = [
    ...
    },
    {
      ...
      description: 'This is a react API project that displays the top 6 cryptocurrencies by market capitalization. The data is fetched from the CoinGecko API. The project is built with React, HTML, and CSS.',
